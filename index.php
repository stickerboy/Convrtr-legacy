...
$rot_decode	= (isset($_POST['rot_decode'])) ? true : false;
$msy_decode	= (isset($_POST['msy_decode'])) ? true : false;

$text = $bin = $hex = $b64 = $dec = $rev = $mor = $rot13 = $msy = $hash = '';
...
if($rot_decode)	 { include($root_path . 'inc/decoders/rot.php'); }
...
if (isset($_GET['rot_download'])) {
	header("Content-type: text/plain");
	header("Content-Disposition: attachment; filename=Rot13");
	header("Content-Description: Convrts Data");
	echo $_SESSION['rot13'];
	exit;
}
